...
#Substring allows to specify a starting point and how many characters to take from anywhere in the string. 
...
#locate index position - we have 2 arguments we can use here: we can specify what we are searching for and where to search
